...
public class JobInterviewCard extends AbstractQuizCard {
    ...
    public JobInterviewCard() {
        ...
        if (AbstractDungeon.player != null && AbstractDungeon.player.hasPower(CodeQuestionStreakPower.POWER_ID)) {
            this.baseDamage = 6 + AbstractDungeon.player.getPower(CodeQuestionStreakPower.POWER_ID).amount;
        } else {
            this.baseDamage = 6;
        }
